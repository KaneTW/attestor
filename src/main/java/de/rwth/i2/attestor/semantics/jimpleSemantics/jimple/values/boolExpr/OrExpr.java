...
public class OrExpr implements BoolValue {
    private final BoolValue leftExpr;
    private final BoolValue rightExpr;

    private final ViolationPoints potentialViolationPoints;

    private final ITSDisjunction formula;

    public OrExpr(BoolValue leftExpr, BoolValue rightExpr) {
        ...
        this.formula = new ITSDisjunction(leftExpr.asITSFormula(), rightExpr.asITSFormula());
    }
